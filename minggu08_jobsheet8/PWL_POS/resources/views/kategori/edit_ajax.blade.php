         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="form-group">
                     ...
                     <input value="{{ $kategori->kode_kategori }}" type="text" name="kode_kategori" id="kode_kategori" class="form-control" required>
                     <small id="error-kode_kategori" class="error-text form-text textdanger"></small>
                 </div>
                 <div class="form-group">
