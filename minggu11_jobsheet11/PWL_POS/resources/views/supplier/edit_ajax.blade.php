         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $supplier->supplier_no_hp }}" type="text" name="supplier_no_hp" id="supplier_no_hp" class="form-control" required>
                    <small id="error-supplier_no_hp" class="error-text form-text text-danger"></small>
                </div>
             </div>
